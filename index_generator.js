...
const readAndWrite = (outputStream, { source_dir = './', prefix = '', postfix = '' }) =>
  new Promise((res, rej) => {
    ...
    rl.on('line', line => outputStream.write(
      line
        .replace(/default as \w+/g, pipe(
          split(' '),
          last,
...
const writeALine = (stream, text) => new Promise((res, rej) => {
